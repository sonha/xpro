...
<form class="form-horizontal" role="form" action="<?php echo $this->createUrl('user/save') ?>" method="post">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="text" id="form-field-2" placeholder="User name" name="name"  class="col-xs-10 col-sm-5" />
...
<div class="form-group">
    ...
    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Mobile </label>
        <div class="col-sm-9">
            ...
            <input type="text" id="form-field-2" placeholder="Password" name="mobile"   class="col-xs-10 col-sm-5" />
        </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <input type="text" id="form-field-2" placeholder="Email" name="email"   class="col-xs-10 col-sm-5" />
    </div>
</div>
<div class="space-4"></div>
