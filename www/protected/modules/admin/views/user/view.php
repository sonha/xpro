...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl;?>/admin/assets/css/jquery.gritter.css" />
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl;?>/admin/assets/css/select2.css" />
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl;?>/admin/assets/css/bootstrap-editable.css" />
