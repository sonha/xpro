...
<div class="col-xs-12">
    <div class="table-header">
        Danh sách <?php echo $this->pageTitle;?>
        <div class="widget-toolbar">
            <label>
                <a href="<?php echo Yii::app()->createUrl("admin/category/create")?>" class="btn btn-sm btn-danger">Thêm <?php echo $this->pageTitle;?></a>
            </label>
        </div>
    </div>
            ...
            array(
                ...
                'buttons' => array(
                    ...
                    'view' => array(
                        ...
                        'imageUrl' => false,
                        'url' => 'Yii::app()->createUrl("admin/category/admin")',
                    ),
                    'delete' => array(
                        'options' => array(
