...
//            ?>
            ...
            <form class="form-horizontal" role="form" action="<?php echo $this->createUrl('type/update') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="form-field-2" placeholder="Type name" name="type_name" value="<?php echo $model->type_name; ?>"  class="col-xs-10 col-sm-5" />
