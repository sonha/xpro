...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="admin/assets/css/sexy.min.css" />
        <link rel="stylesheet" href="admin/assets/css/sexy-rtl.min.css" />
        <link rel="stylesheet" href="admin/assets/css/sexy-skins.min.css" />

        <!--[if lte IE 8]>
        <link rel="stylesheet" href="admin/assets/css/sexy-ie.min.css" />
        <![endif]-->
        ...
        <script src="admin/assets/js/sexy-extra.min.js"></script>
