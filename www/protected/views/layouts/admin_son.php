...
<div class="navbar-header pull-left">
    <a href="<?php echo Yii::app()->request->baseUrl;?>/admin" class="navbar-brand">
        <small>
            <i class="icon-leaf"></i>
            Ace Admin
        </small>
...
<script src="<?php echo Yii::app()->request->baseUrl;?>/admin/assets/js/jquery.sparkline.min.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl;?>/admin/assets/js/flot/jquery.flot.min.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl;?>/admin/assets/js/flot/jquery.flot.pie.min.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl;?>/admin/assets/js/flot/jquery.flot.resize.min.js"></script>
...
<!--Son HA : phai bo doan nay di thi moi filter duoc nhe  -->
<!--<script type="text/javascript">-->
<!--    jQuery(function($) {-->
